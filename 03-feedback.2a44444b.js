...
"use strict";var e=t(require("../../node_modules/lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form"),r=document.querySelector('[name="email"]'),l=document.querySelector('[name="message"]'),o="feedback-form-state",s=()=>{let e={email:`${r.value}`,message:`${l.value}`};localStorage.setItem(o,JSON.stringify(e))},n=()=>{try{r.value=JSON.parse(localStorage.getItem(o)).email,l.value=JSON.parse(localStorage.getItem(o)).message}catch{console.log("There is no data. Please enter data!")}},c=e=>{e.preventDefault();const{elements:{email:t,message:r}}=e.currentTarget;console.log(JSON.parse(localStorage.getItem(o))),a.reset(),e.currentTarget.reset(),localStorage.clear()};n(),a.addEventListener("input",(0,e.default)(s,500)),a.addEventListener("submit",c);
},{"../../node_modules/lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/parcel-project-template/03-feedback.2a44444b.js.map