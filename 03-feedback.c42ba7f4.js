...
const e=require("lodash/throttle"),t=document.querySelector(".feedback-form"),a=document.querySelector('[name="email"]'),r=document.querySelector('[name="message"]'),l="feedback-form-state",o=()=>{let e={email:`${a.value}`,message:`${r.value}`};localStorage.setItem(l,JSON.stringify(e))},s=()=>{try{a.value=JSON.parse(localStorage.getItem(l)).email,r.value=JSON.parse(localStorage.getItem(l)).message}catch{console.log("There is no data. Please enter data!")}},c=e=>{e.preventDefault();const{elements:{email:a,message:r}}=e.currentTarget;console.log(JSON.parse(localStorage.getItem(l))),t.reset(),e.currentTarget.reset(),localStorage.clear()};s(),t.addEventListener("input",e(o,500)),t.addEventListener("submit",c);
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/parcel-project-template/03-feedback.c42ba7f4.js.map